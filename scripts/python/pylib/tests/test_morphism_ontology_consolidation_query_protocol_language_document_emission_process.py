...
COMMITTED_DOCUMENT = REPOSITORY / "ontology/queries.sparql"
MODULE = (
    "silmaril.sparky.morphism.ontology.consolidation"
    ".query.protocol.language.document.emission.process"
)
RUNTIME_FILE = (
    ROOT
    / "src/silmaril/sparky/morphism/ontology/consolidation"
    / "query/protocol/language/document/emission/process.py"
)
ENVIRONMENT = {
    **os.environ,
...
def test_query_document_emission_reproduces_committed_document_bytes() -> None:
...
def test_query_document_emission_is_one_gated_projection() -> None:
