...
MORPHISM_USER_INTERFACE_CONSTRUCTOR_SOURCES := $(addprefix $(MORPHISM_USER_INTERFACE_CONSTRUCTOR_SPECIFICATION_ROOT)/,schema.ttl components.ttl styles.ttl queries.ttl shapes.ttl)
