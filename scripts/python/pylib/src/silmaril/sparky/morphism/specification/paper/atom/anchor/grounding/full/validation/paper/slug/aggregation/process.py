...
from config.constants.morphism.specification.paper.atom.anchor.grounding.full.validation.paper.slug.aggregation.process.command.value import VALUE as COMMAND
