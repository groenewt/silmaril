...
from config.constants.morphism.specification.paper.atom.anchor.grounding.full.validation.papers.directory.presence.validation.process.command.value import VALUE as COMMAND
