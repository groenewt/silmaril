...
from config.constants.morphism.specification.paper.atom.anchor.grounding.full.validation.summary.json.construction.process.command.value import VALUE as COMMAND
