...
from config.constants.morphism.specification.paper.atom.anchor.grounding.full.validation.summary.completeness.validation.process.command.value import VALUE as COMMAND
