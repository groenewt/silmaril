...
from config.constants.morphism.specification.paper.atom.anchor.grounding.full.validation.specification.document.instance.relation.parsing.process.command.value import VALUE as COMMAND
