...
from config.constants.morphism.specification.paper.atom.anchor.grounding.full.validation.specification.source.canonical.order.projection.process.command.value import VALUE as COMMAND
