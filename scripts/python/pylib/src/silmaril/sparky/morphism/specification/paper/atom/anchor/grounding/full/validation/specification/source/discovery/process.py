...
from config.constants.morphism.specification.paper.atom.anchor.grounding.full.validation.specification.source.discovery.process.command.value import VALUE as COMMAND
