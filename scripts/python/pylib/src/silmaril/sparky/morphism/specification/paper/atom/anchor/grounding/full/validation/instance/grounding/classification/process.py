...
from config.constants.morphism.specification.paper.atom.anchor.grounding.full.validation.instance.grounding.classification.process.command.value import VALUE as COMMAND
