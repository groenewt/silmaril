from config.constants.morphism.codebase.volume.inventory.catalog_quality_flags.canonical_order.projection.process.command.value import VALUE as COMMAND
