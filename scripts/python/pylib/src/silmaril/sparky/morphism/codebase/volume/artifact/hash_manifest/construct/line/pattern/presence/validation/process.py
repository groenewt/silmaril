...
from config.gate.external.python.morphism.codebase.volume.artifact.hash_manifest.boundary.input.library import INPUT
...
from silmaril.sparky.morphism.codebase.volume.artifact.hash_manifest.construct.line.pattern.presence.validation.apply import apply as APPLY
