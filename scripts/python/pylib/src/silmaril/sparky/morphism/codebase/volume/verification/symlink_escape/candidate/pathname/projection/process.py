from config.constants.morphism.codebase.volume.verification.symlink_escape.candidate.pathname.projection.process.command.value import VALUE as COMMAND
