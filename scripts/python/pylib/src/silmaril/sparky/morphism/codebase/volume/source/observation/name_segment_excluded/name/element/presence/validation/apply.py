from config.gate.external.python.morphism.codebase.volume.source.observation.name_segment_excluded.name.element.presence.validation.library import PROJECT
