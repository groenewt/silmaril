from config.constants.morphism.codebase.volume.atlas.glossary.aggregate.body.comma_separated_values.encode.process.command.value import VALUE as COMMAND
