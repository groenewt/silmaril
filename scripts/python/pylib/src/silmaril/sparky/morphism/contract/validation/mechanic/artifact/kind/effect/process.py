...
from config.constants.morphism.contract.validation.mechanic.artifact.kind.effect.applied.identity.value import VALUE as _ACCEPTED_EFFECT
from config.constants.morphism.contract.validation.mechanic.artifact.kind.effect.decode.failure.identity.value import VALUE as _DECODE_FAILURE_EFFECT
from config.constants.morphism.contract.validation.mechanic.artifact.kind.effect.parse.failure.identity.value import VALUE as _PARSE_FAILURE_EFFECT
from config.constants.morphism.contract.validation.mechanic.artifact.kind.effect.rejected.identity.value import VALUE as _REJECTED_EFFECT
