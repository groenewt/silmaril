...
from config.constants.morphism.contract.validation.mechanic.json.effect.applied.identity.value import VALUE as _ACCEPTED_EFFECT
from config.constants.morphism.contract.validation.mechanic.json.effect.decode.failure.identity.value import VALUE as _DECODE_FAILURE_EFFECT
from config.constants.morphism.contract.validation.mechanic.json.effect.parse.failure.identity.value import VALUE as _PARSE_FAILURE_EFFECT
from config.constants.morphism.contract.validation.mechanic.json.effect.rejected.identity.value import VALUE as _REJECTED_EFFECT
