...
from config.constants.morphism.contract.validation.schema.format.uri.reference.effect.applied.identity.value import VALUE as _ACCEPTED_EFFECT
from config.constants.morphism.contract.validation.schema.format.uri.reference.effect.decode.failure.identity.value import VALUE as _DECODE_FAILURE_EFFECT

from config.constants.morphism.contract.validation.schema.format.uri.reference.effect.rejected.identity.value import VALUE as _REJECTED_EFFECT
