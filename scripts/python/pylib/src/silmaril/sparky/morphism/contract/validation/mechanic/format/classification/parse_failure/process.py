...
from config.constants.morphism.contract.validation.classification.parse_failure.value import VALUE as _TOKEN
...
_PATTERN = rb"\A" + _UNCLASSIFIED + rb"(?!(?:uri|uri-reference|date-time)\x00)[\x00-\x7f]*\Z"
