...
from silmaril.sparky.morphism.codebase.volume.artifact.hash_line.construct.effect.value import Value as Effect
from silmaril.sparky.morphism.codebase.volume.artifact.hash_line.construct.frame.value import Value as Frame
from silmaril.sparky.morphism.codebase.volume.artifact.hash_line.construct.output.value import Value as Output
