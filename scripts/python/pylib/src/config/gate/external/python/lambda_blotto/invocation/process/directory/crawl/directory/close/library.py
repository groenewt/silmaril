...
from silmaril.sparky.lambda_blotto.invocation.process.directory.crawl.directory.close.frame.value import Value as Frame
from silmaril.sparky.lambda_blotto.invocation.process.directory.crawl.directory.close.input.value import Value as Input
