...
from silmaril.sparky.morphism.codebase.volume.table.evidence_rows.effect.value import Value as Effect
from silmaril.sparky.morphism.codebase.volume.table.evidence_rows.frame.value import Value as Frame
from silmaril.sparky.morphism.codebase.volume.table.evidence_rows.output.value import Value as Output
