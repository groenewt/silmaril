...
from config.gate.external.python.morphism.codebase.volume.artifact.manifest.csv_artifact.expected.canonical_order.projection.state.library import STATE
