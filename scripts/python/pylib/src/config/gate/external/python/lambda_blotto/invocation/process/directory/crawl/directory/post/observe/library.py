...
from silmaril.sparky.lambda_blotto.invocation.process.directory.crawl.directory.post.observe.frame.value import Value as Frame
from silmaril.sparky.lambda_blotto.invocation.process.directory.crawl.directory.post.observe.input.value import Value as Input
