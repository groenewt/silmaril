...
from silmaril.sparky.morphism.codebase.volume.verification.process_coverage.effect.value import Value as Effect
from silmaril.sparky.morphism.codebase.volume.verification.process_coverage.frame.value import Value as Frame
from silmaril.sparky.morphism.codebase.volume.verification.process_coverage.output.value import Value as Output
