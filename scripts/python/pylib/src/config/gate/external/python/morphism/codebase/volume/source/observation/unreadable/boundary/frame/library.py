...
from silmaril.sparky.morphism.codebase.volume.source.observation.unreadable.effect.value import Value as Effect
from silmaril.sparky.morphism.codebase.volume.source.observation.unreadable.frame.value import Value as Frame
from silmaril.sparky.morphism.codebase.volume.source.observation.unreadable.output.value import Value as Output
