...
from silmaril.sparky.morphism.codebase.volume.table.telephone_topology.effect.value import Value as Effect
from silmaril.sparky.morphism.codebase.volume.table.telephone_topology.frame.value import Value as Frame
from silmaril.sparky.morphism.codebase.volume.table.telephone_topology.output.value import Value as Output
