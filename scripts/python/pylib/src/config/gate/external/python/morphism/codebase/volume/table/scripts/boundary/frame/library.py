...
from silmaril.sparky.morphism.codebase.volume.table.scripts.effect.value import Value as Effect
from silmaril.sparky.morphism.codebase.volume.table.scripts.frame.value import Value as Frame
from silmaril.sparky.morphism.codebase.volume.table.scripts.output.value import Value as Output
