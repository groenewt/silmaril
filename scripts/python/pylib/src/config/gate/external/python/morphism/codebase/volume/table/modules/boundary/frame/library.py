...
from silmaril.sparky.morphism.codebase.volume.table.modules.effect.value import Value as Effect
from silmaril.sparky.morphism.codebase.volume.table.modules.frame.value import Value as Frame
from silmaril.sparky.morphism.codebase.volume.table.modules.output.value import Value as Output
