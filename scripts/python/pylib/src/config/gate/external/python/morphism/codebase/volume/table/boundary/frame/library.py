...
from silmaril.sparky.morphism.codebase.volume.table.source_files.effect.value import Value as Effect
from silmaril.sparky.morphism.codebase.volume.table.source_files.frame.value import Value as Frame
from silmaril.sparky.morphism.codebase.volume.table.source_files.output.value import Value as Output
