...
from config.gate.external.python.morphism.codebase.volume.table.dependencies.boundary.frame.library import FRAME
from config.gate.external.python.morphism.codebase.volume.table.transform.construct.dependencies.library import RENDER
from config.gate.external.python.morphism.codebase.volume.table.encode.library import ENCODE_TABLE
from silmaril.sparky.morphism.codebase.volume.table.dependencies.frame.value import Value as Frame
from silmaril.sparky.morphism.codebase.volume.table.dependencies.input.value import Value as Input
