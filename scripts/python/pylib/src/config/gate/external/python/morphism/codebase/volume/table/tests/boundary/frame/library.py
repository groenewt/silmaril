...
from silmaril.sparky.morphism.codebase.volume.table.tests.effect.value import Value as Effect
from silmaril.sparky.morphism.codebase.volume.table.tests.frame.value import Value as Frame
from silmaril.sparky.morphism.codebase.volume.table.tests.output.value import Value as Output
