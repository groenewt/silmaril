...
from silmaril.sparky.morphism.codebase.volume.table.shared_components.effect.value import Value as Effect
from silmaril.sparky.morphism.codebase.volume.table.shared_components.frame.value import Value as Frame
from silmaril.sparky.morphism.codebase.volume.table.shared_components.output.value import Value as Output
