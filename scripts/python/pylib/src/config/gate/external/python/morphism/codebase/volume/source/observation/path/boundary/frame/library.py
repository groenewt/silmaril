...
from silmaril.sparky.morphism.codebase.volume.source.observation.path.effect.value import Value as Effect
from silmaril.sparky.morphism.codebase.volume.source.observation.path.frame.value import Value as Frame
from silmaril.sparky.morphism.codebase.volume.source.observation.path.output.value import Value as Output
