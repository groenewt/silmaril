...
from silmaril.sparky.morphism.codebase.volume.table.phase14.effect.value import Value as Effect
from silmaril.sparky.morphism.codebase.volume.table.phase14.frame.value import Value as Frame
from silmaril.sparky.morphism.codebase.volume.table.phase14.output.value import Value as Output
