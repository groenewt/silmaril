...
from silmaril.sparky.morphism.codebase.volume.artifact.hash_manifest.construct.effect.value import Value as Effect
from silmaril.sparky.morphism.codebase.volume.artifact.hash_manifest.construct.frame.value import Value as Frame
from silmaril.sparky.morphism.codebase.volume.artifact.hash_manifest.construct.output.value import Value as Output
