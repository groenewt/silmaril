...
from config.gate.external.python.morphism.codebase.volume.source.observation.name_segment_excluded.boundary.frame.library import FRAME
from config.gate.external.python.morphism.codebase.volume.source.observation.name_segment_excluded.input.parse.state.library import STATE
