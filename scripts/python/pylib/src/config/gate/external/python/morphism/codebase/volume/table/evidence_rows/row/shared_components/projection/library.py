...
from config.gate.external.python.morphism.codebase.volume.table.evidence.boundary.frame.library import FRAME
from config.gate.external.python.morphism.codebase.volume.table.evidence.transform.row.shared_components.library import STATE
