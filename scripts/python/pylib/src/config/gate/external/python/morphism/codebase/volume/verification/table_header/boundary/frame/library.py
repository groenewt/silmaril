...
from silmaril.sparky.morphism.codebase.volume.verification.table_header.effect.value import Value as Effect
from silmaril.sparky.morphism.codebase.volume.verification.table_header.frame.value import Value as Frame
from silmaril.sparky.morphism.codebase.volume.verification.table_header.output.value import Value as Output
