...
from config.gate.external.python.morphism.codebase.volume.table.configuration.boundary.frame.library import FRAME
from config.gate.external.python.morphism.codebase.volume.table.transform.construct.configuration.library import RENDER
...
from silmaril.sparky.morphism.codebase.volume.table.configuration.input.value import Value as Input
